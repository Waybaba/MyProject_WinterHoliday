...
input_train = input_train[:,:,[3,2,1,0,4,5,6,8,9,10,12,13,14,16,17,18],:]
input_test = input_test[:,:,[3,2,1,0,4,5,6,8,9,10,12,13,14,16,17,18],:]
print('input_train shape:', input_train.shape)
print('input_test shape:', input_test.shape)

input_train = input_train.reshape((-1,50,3*16))#数据整形，然后输
input_test = input_test.reshape((-1,50,3*16))
...
model.add(layers.LSTM(
    units=128,
    batch_input_shape=(None, 50, 3*16),#75相当于特征数量，或者也可以叫维度，这里有3*25个坐标点，要提前整形
