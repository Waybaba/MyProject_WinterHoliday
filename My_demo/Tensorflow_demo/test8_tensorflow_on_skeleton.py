...
with tf.name_scope('NETWOARS'):
    l1 = add_my_layer(inputs=xs,in_size=3750, out_size=4, activation_function=tf.nn.relu,dropout=True)
    prediction = add_my_layer(inputs=l1,in_size=4,out_size=4, activation_function=tf.nn.softmax)
